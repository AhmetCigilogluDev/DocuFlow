DocuFlow is a multi-layered .NET Web API application designed to manage documents and folders securely, with support for JWT-based authentication and Swagger testing interface.
Features
